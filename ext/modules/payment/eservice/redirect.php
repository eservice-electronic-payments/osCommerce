...
chdir('../../../../');
  ...
  require(DIR_WS_INCLUDES . 'modules/payment/eservice.php');
  $payment = new eservice();
  if($payment->get_sandbox_environment()){
      $cashier_url = $payment->payment_eservice_test_cashier_url;
  }else{
      $cashier_url = $payment->payment_eservice_cashier_url;
  }
  $params = array();
